...
namespace kaspactl
{
    ...
    /// </summary>
    public class GetVirtualSelectedParentBlueScore
    {

        public class Rootobject
        {
            public Getvirtualselectedparentbluescoreresponse getVirtualSelectedParentBlueScoreResponse { get; set; }
        }

        public class Getvirtualselectedparentbluescoreresponse
        {
