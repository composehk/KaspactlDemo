...
namespace kaspactl
{
    ...
    /// </summary>
    public class GetMempoolEntriesByAddresses
    {

        public class Rootobject
        {
            public Getmempoolentriesbyaddressesresponse getMempoolEntriesByAddressesResponse { get; set; }
        }

        public class Getmempoolentriesbyaddressesresponse
        {
